...
public class MobileReceiveAndSendProductActionModel extends MobileReceiveAndSendItemActionModel
{
	/**<i>Generated model type code constant.</i>*/
	public static final String _TYPECODE = "MobileReceiveAndSendProductAction";
	
	
	/**
	 * <i>Generated constructor</i> - Default constructor for generic creation.
	 */
	public MobileReceiveAndSendProductActionModel()
	{
		super();
	}
	 ...
	 */
	public MobileReceiveAndSendProductActionModel(final ItemModelContext ctx)
	{
		super(ctx);
	}
	 ...
	 * @param _content initial attribute declared by type <code>MobileReceiveAndSendProductAction</code> at extension <code>mobileservices</code>
	 ...
	 */
	@Deprecated
	public MobileReceiveAndSendProductActionModel(final String _code, final ProductModel _content, final DeeplinkUrlModel _deeplinkUrl, final String _target, final ActionType _type)
	{
		super();
		setCode(_code);
		setContent(_content);
	 ...
	 */
	@Deprecated
	public MobileReceiveAndSendProductActionModel(final String _code, final ProductModel _content, final DeeplinkUrlModel _deeplinkUrl, final ItemModel _owner, final String _target, final ActionType _type)
	{
		super();
		setCode(_code);
		setContent(_content);
	...
	{
		return (ProductModel) super.getContent();
	}
	
	/**
	 * <i>Generated method</i> - Setter of <code>MobileReceiveAndSendItemAction.content</code> attribute defined at extension <code>mobileservices</code> and redeclared at extension <code>mobileservices</code>. Will only accept values of type {@link de.hybris.platform.core.model.product.ProductModel}. 
	 *  
