...
public class BusinessProcessEventTriggeringIntegrationTest extends ServicelayerBaseTest
{
	...
	public void shouldFailWhenEventHasBeenAlreadyTriggeredWithoutChoice()
	{
		...
		final boolean triggeredWithChoice = businessProcessService
				.triggerEvent(BusinessProcessEvent.builder(eventId).withChoice("choice").build());

		assertThat(triggeredFirsTime).isTrue();
		assertThat(triggeredWithoutChoice).isTrue();
	...
	public void shouldFailWhenEventHasBeenAlreadyTriggeredWithChoice()
	{
		...
		final boolean triggeredWithoutChoice = businessProcessService.triggerEvent(BusinessProcessEvent.newEvent(eventId));
		final boolean triggeredWithTheSameChoice = businessProcessService
				.triggerEvent(BusinessProcessEvent.builder(eventId).withChoice("choice").build());
		final boolean triggeredWithOtherChoice = businessProcessService
				.triggerEvent(BusinessProcessEvent.builder(eventId).withChoice("orher_choice").build());
