        ...
        <c:if test="${hasPreviousPage}">
            <li class="pagination-prev">
                ...
                <ycommerce:testId code="searchResults_previousPage_link">
                    <a href="${previousPageUrl}" rel="prev"><spring:theme code="text.account.customerList.page.firstPage"/></a>
                </ycommerce:testId>
            </li>
        </c:if>

        <c:if test="${!hasPreviousPage}">
            <li class="pagination-prev disabled"><span><spring:theme code="text.account.customerList.page.firstPage"/></span></li>
        </c:if>
        ...
        <c:if test="${hasNextPage}">
            <li class="pagination-next">
                ...
                <ycommerce:testId code="searchResults_nextPage_link">
                    <a href="${nextPageUrl}" rel="next"><spring:theme code="text.account.customerList.page.lastPage"/></a>
                </ycommerce:testId>
            </li>
        </c:if>

        <c:if test="${!hasNextPage}">
            <li class="pagination-next disabled"><span><spring:theme code="text.account.customerList.page.lastPage"/></span></li>
        </c:if>
    </ul>
</c:if>