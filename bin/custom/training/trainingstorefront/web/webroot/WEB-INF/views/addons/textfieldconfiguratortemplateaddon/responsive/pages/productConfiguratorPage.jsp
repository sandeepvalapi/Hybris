...
<template:page pageTitle="${pageTitle}">
    <jsp:body>
        <form:form method="post" id="textFieldConfigurationForm" action="${addToCartUrl}">
            <input id="quantity" name="quantity" type="hidden" value="${fn:escapeXml(qty)}" hidden="hidden">
            ...
            <div class="row">
                <div class="col-sm-12 col-md-6">
                    <button id="addToCartButton" type="${fn:escapeXml(buttonType)}" class="btn btn-primary btn-block js-add-to-cart js-enable-btn btn-icon glyphicon-shopping-cart" disabled="disabled">
